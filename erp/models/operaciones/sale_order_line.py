            ...
            if price_list_item.base == 'purchase':
                if price_list_item.product_tmpl_id.id == self.product_id.product_tmpl_id.id:
                    ...
                    if price_list_item.sale_percent != 100:
                        price_list_item.sale_percent = price_list_item.price_list_item.sale_percent - price_list_item.discount
                        price_before_sale_comision = price_list_item.price_list_item.price_before_sale_comision()
